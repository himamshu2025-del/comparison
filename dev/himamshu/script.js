...
// Generate global insights on button click
...
// Display country insights on select change
countrySelect.addEventListener("change", () => {
  ...
  countryData[country].forEach(ins => {
    const li = document.createElement("li");
    li.textContent = ins;
    ul.appendChild(li);
  });
